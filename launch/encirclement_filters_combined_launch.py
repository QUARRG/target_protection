...
def parse_yaml(context):
    ...
    for robot in robots_list:
        ...
        # GPS - Scanner Node for each robot
        Nodes.append(Node(
            package='crazy_encirclement',
            executable='gps_scanner',
            name=robot+'_gps_scanner_node',
            output='screen',
            parameters=[{'robot': robot} | filter_yaml_content.get('FilterRelative', {})],
        ))
