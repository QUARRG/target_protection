...
def parse_yaml(context):
    ...
    for robot in robots_list:
        ...
        Nodes.append(Node(
            ...
            executable='target_encirclement',
            name=robot+'_target_encirclement',
            output='screen',
            parameters=[{'robot': robot, 'number_of_agents': len(robots_list),'relative':relative} \
